          ...
          <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4 lg:w-1/2'>
              <div className='mb-12 flex lg:mb-[70px]'>
                ...
                <div className='w-full'>
                  <h3 className='mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl'>
                    {siteConfig('COMPANY_FAQ_1_QUESTION')}
                  </h3>
                  <p
                    dangerouslySetInnerHTML={{
                      __html: siteConfig('COMPANY_FAQ_1_ANSWER')
                    }}
              ...
              <div className='mb-12 flex lg:mb-[70px]'>
                ...
                <div className='w-full'>
                  <h3 className='mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl'>
                    {siteConfig('COMPANY_FAQ_2_QUESTION')}
                  </h3>
                  <p
                    dangerouslySetInnerHTML={{
                      __html: siteConfig('COMPANY_FAQ_2_ANSWER')
                    }}
                    className='text-base text-body-color dark:text-dark-6'></p>
                </div>
              </div>
            ...
            <div className='w-full px-4 lg:w-1/2'>
              <div className='mb-12 flex lg:mb-[70px]'>
                ...
                <div className='w-full'>
                  <h3 className='mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl'>
                    {siteConfig('COMPANY_FAQ_3_QUESTION')}
                  </h3>
                  <p
                    dangerouslySetInnerHTML={{
                      __html: siteConfig('COMPANY_FAQ_3_ANSWER')
                    }}
                    className='text-base text-body-color dark:text-dark-6'></p>
                </div>
              </div>
              <div className='mb-12 flex lg:mb-[70px]'>
                ...
                <div className='w-full'>
                  <h3 className='mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl'>
                    {siteConfig('COMPANY_FAQ_4_QUESTION')}
                  </h3>
                  <p
                    dangerouslySetInnerHTML={{
                      __html: siteConfig('COMPANY_FAQ_4_ANSWER')
                    }}
                    className='text-base text-body-color dark:text-dark-6'></p>
                </div>
              </div>
